    ...
    <div :class="contentClass">
      ...
      <div class="text-base italic leading-loose">
        ...
        <p>
          <a
            class="underline bold text-blue-500"
            href="https://github.com/bpecsek/Programming-Language-Benchmarks"
            target="_blank"
            >CONTRIBUTIONS</a
          >
          are WELCOME!
          ...
          <table class="table-auto w-full text-xs leading-loose">
            ...
            <tbody class="font-light">
              ...
              >
                ...
                <td class="text-right">
                  <a
                    :href="`https://github.com/bpecsek/Programming-Language-Benchmarks/blob/main/bench/algorithm/${test}/${i.code}`"
                    target="_blank"
...
export default class LangMetaPage extends Vue {
  ...
  get buildLogUrl() {
    ...
    return `https://github.com/bpecsek/Programming-Language-Benchmarks/actions/runs/${runId}`
  }
